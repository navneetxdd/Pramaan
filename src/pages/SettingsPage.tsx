  ...
  return (
    <div className="mx-auto flex max-w-xl flex-col gap-4">
      <header>
        ...
        <p className="mt-1 text-[14px] text-[var(--text-secondary)]">Workstation storage and report signing.</p>
      </header>

      <section className="visily-card space-y-3 p-4">
        <div>
          <p className="text-[13px] font-medium text-[var(--text-primary)]">Data directory</p>
          <p className="mt-0.5 text-[12px] text-[var(--text-tertiary)]">Cases, exports, and custody records.</p>
        </div>
      ...
      <section className="visily-card space-y-3 p-4">
        <div>
          ...
          <p className="mt-0.5 text-[12px] leading-relaxed text-[var(--text-tertiary)]">
            Exported reports are signed on this machine. In your PDF reader, open signature properties and compare to this
            value.
          </p>
        </div>
      ...
      <section className="visily-card space-y-3 p-4">
        <div>
          ...
          <p className="mt-0.5 text-[12px] text-[var(--text-tertiary)]">
            Optional — runs OEM parser fixtures on this machine. Not required for normal case work.
          </p>
        </div>
